...
| Step | Agent | Action |
|------|-------|--------|
| 1 | `project-planner` | Create docs/{id}-PLAN.md |
...
|----------------|--------|
| NO `docs/{id}-PLAN.md` | → Go to PHASE 1 (planning only) |
| YES `docs/{id}-PLAN.md` + user approved | → Go to PHASE 2 (implementation) |

### Step 3: Execute Based on Phase

**PHASE 1 (Planning):**
```
Use the project-planner agent to create {id}-PLAN.md
...
**TASK:** Create detailed {id}-PLAN.md based on ABOVE decisions. Do NOT infer from folder name.
```
